...
**Authors:** Yilin Zhang, Xinran Zhao, Zora Zhiruo Wang et 3 autres  
**ArXiv ID:** 2506.15655v1  
**Published:** 2025-06-18  
**Categories:** cs.SE  
**ArXiv Link:** http://arxiv.org/abs/2506.15655v1  
**PDF Link:** http://arxiv.org/pdf/2506.15655v1  
...
propose chunking via Abstract Syntax Trees (...
...
`#arxiv` `#cs.SE` `#llm-compression` `#[add-specific-tags]`
